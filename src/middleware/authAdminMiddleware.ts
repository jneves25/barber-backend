...
export const authAdminMiddleware = (req: Request, res: Response, next: NextFunction): void => {
	...
	try {
		...
		if (typeof decoded === 'object' && 'userId' in decoded) {
			req.userId = (decoded as jwt.JwtPayload).userId; // Adiciona o userId no req para uso posterior
